...
pinecone_index_name = "edu-research-tutorial"
index_name = "edu-research-tutorial"
...
def query_pinecone_tutorial(query, dok_level):
...
if __name__ == "__main__":
    ...
    response = query_pinecone_tutorial(query, dok_level)
    print(response)
